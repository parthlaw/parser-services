...
export const generateHostedCheckout = async (subscriptionItems: ChargebeeItemPrice[], customer: ChargebeeCustomerCreateDto) => {
    try {
...
export const generateHostedCheckoutOneTime = async (chargeItems: ChargebeeItemPrice[], customer: ChargebeeCustomerCreateDto) => {
    const chargebee = getChargebeeClient();
